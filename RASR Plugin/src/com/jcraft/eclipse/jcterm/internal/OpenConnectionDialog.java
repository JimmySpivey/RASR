...
class OpenConnectionDialog extends TrayDialog{
  ...
  public OpenConnectionDialog(Shell parentShell, String instruction,
    ...
    this.message=NLS.bind(Messages.OpenConnectionDialog_message,
        new String[] {""
  ...
  protected void configureShell(Shell newShell){
    ...
    PlatformUI.getWorkbench().getHelpSystem().setHelp(newShell,
        IHelpContextIds.OPEN_CONNECTION_DIALOG);
  ...
  protected Control createDialogArea(Composite parent){
    ...
    keyLockImage=JCTermPlugin.getImageDescriptor(IUIConstants.IMG_TERMINAL32)
        .createImage();
